            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <span class="fa fa-pencil" aria-hidden="true"></span> Wijzig categorie: <strong>{{ $category->name }}</strong>
                    </div>

                    <div class="panel-body">

                        <form method="POST" class="form-horizontal" action="{{ route('category.update', $category) }}">
                            ...
                            <div class="form-group @error('name', 'has-error')">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" placeholder="Naam van de categorie" @input('name', $category->name)>
                                    @error('name')
                                </div>
                            </div>
                            ...
                            <div class="form-group @error('description', 'has-error')">
                                ...
                                <div class="col-md-6">
                                    <textarea name="description" placeholder="De beschrijving van het label." class="form-control" rows="7">@text('description', $category->description)</textarea>
                                    @error('description')
                                </div>
                            </div>
