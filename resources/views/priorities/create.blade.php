            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <span class="fa fa-plus" aria-hidden="true"></span> Priorieit  toevoegen
                    </div>

                    <div class="panel-body">

                        <form method="POST" class="form-horizontal" action="{{ route('priority.store') }}">
                            {{ csrf_field() }} {{-- CSRF form filed protection --}}

                            <div class="form-group @error('name', 'has-error')">
                                <label class="col-md-2 control-label">
                                    Prioriteit naam: <span class="text-danger">*</span>
                                </label>
                            ...
                            <div class="form-group @error('color', 'has-error')">
                                <label class="col-md-2 control-label">
                                    Prioriteit kleur: <span class="text-danger">*</span>
                                </label>
                            ...
                            <div class="form-group @error('description', 'has-error')">
                                <label class="col-md-2 control-label">
                                    Prior. beschrijving: <span class="text-danger">*</span>
                                </label>
